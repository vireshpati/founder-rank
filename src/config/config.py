...
class Config:
    MATRIX = {
        ...
        "EXIT": {
            "TIERS": {0: "No", 1: "$1-25M", 2: "$25-100M", 3: "$100M+"},  # Tier 0  # Tier 1  # Tier 2  # Tier 3
            "WEIGHT": 5,
            "DIMENSION": 4,
        },
        # Previous founder experience scoring
        "FOUNDER": {
            "TIERS": {1: "No", 2: "Yes - unsuccessful", 3: "Yes - successful"},  # Tier 1  # Tier 2  # Tier 3
            "WEIGHT": 1,
            "DIMENSION": 3,
        },
    ...
    SYNTH = {
        "POPULATIONS": {
            "successful": {
                "fraction": 0.5,
                "sampling_probs": {
                    "UNDERGRAD": np.array([0.02, 0.28, 0.70]),
                    "GRADUATE": np.array([0.10, 0.15, 0.25, 0.50]),
                    "EXIT": np.array([0.30, 0.25, 0.20, 0.25]),
                    "FOUNDER": np.array([0.20, 0.30, 0.50]),
                    "STARTUP": np.array([0.05, 0.25, 0.70]),
                    "COMPANY": np.array([0.10, 0.20, 0.70]),
                    "SENIORITY": np.array([0.10, 0.40, 0.50]),
                    "EXPERTISE": np.array([0.05, 0.05, 0.90]),
                },
                "p_funding": 0.95,
                "mu_funding": 16.0,
                "sigma_funding": 0.8,
            ...
            "control": {
                "fraction": 0.20,
                "sampling_probs": {
                    "UNDERGRAD": np.array([0.65, 0.30, 0.05]),
                    ...
                    "EXPERTISE": np.array([0.50, 0.25, 0.25]),
                },
                "p_funding": 0.10,
                "mu_funding": 13.5,
                "sigma_funding": 0.7,
